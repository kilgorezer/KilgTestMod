...
#define GAME_APP_ALT   "ClassiCube 1.3.7 web mobile + Kilgorezer's Test Mod 1.0"
#define GAME_APP_NAME  "ClassiCube 1.3.7 web + Kilgorezer's Test Mod 1.0"
#define GAME_APP_TITLE "Test Mod"
#else
#define GAME_APP_NAME  "ClassiCube 1.3.7 + Kilgorezer's Test Mod"
